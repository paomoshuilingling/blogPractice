...
<div>
    ...
    <section>
        <header>
            <div id="hometitle">
                ...
                <div id="title">
                    ...
                    <p>我叫熊宇，热爱生活，热爱美食，热爱运动，大千世界中平凡的一员，涉足于互联网领域，专注于前端。欢迎大家交流学习，指正意见。</p>
                </div>
            </div>
        </header>
        ...
        <div id="introduce">
                ...
                <img class="circle2" src="../../design/me.jpg"/>

                <h1>Hi,I'm xiongyu</h1>

                <p>我是一名前端开发者，在学习新知识的时候我们需要量力而为，把一个兴趣经过一定时间的学习、研究转化为自己的知识后再去转向下一个兴趣，，甚至做到学而时习之，这样才可以年年有鱼，年年有余。</p>
