...
<article id="about">
    <section>
        <div class="circle3">
            <img class="circle4 me" src="../../design/me.jpg"/></div>
        <div class="circle5">
            <img class="circle6 phone" src="../../design/phone.jpg"/></div>
        <div class="circle5">
            <img class="circle6" src="../../design/school.jpg"/><label id="lb1">2011年</label><label
                id="lb2">2015年</label></div>
        <div class="circle5">
            <img class="circle6" src="../../design/company.jpg"/><label id="lb3">2015年</label></div>
        <div class="circle5">
            <img class="circle6" src="../../design/project.jpg"/><label id="lb4">2015年</label><label
                id="lb5">2015年</label><label id="lb6">2015年</label></div>
        <div id="left-about">
            <div>
                <img src="../../design/玫瑰心.gif" style="margin-left: -300px;margin-top:-200px;width:166.5px;height:135px;"/>
                <h1>基本信息</h1>
            </div>
            <div>
                <h1>联系方式</h1>
        ...
        <div id="right-about">
            <div>
                <img src="../../design/玫瑰心.gif" style="margin-top:-100px;float:right;height:135px;width:166.5px;"/>
                <p>姓名：熊宇</p>
                <p>出生日期：1992年12月19日</p>
                <p>家乡：湖北咸宁</p>
                <p>爱好：跑步、音乐、电影、编程</p>
            </div>
            <div>
                <p><img src="../../design/tel.jpg" />15968997233</p>

                <p><img src="../../design/qq.jpg" />1538172955</p>

                <p><img src="../../design/weixin.jpg" />elbbub-</p>

                <p><img src="../../design/sina.jpg" />泡沫9水灵灵</p>
            </div>
            <div>
                <p>湖南大学·计算机科学与技术·智能科学与技术</p>

                <p>浙江大学·软件工程·大数据开发与应用技术</p>
            </div>
            <div>
                <p>宁波华数广电网络有限公司·信息管理平台</p>

                <p>javaweb开发实习生</p>

                <p>
                    跟项目主管和另两个组员一起开发该公司的人员事务管理系统。通过近两个月的经历对开发javaweb项目有了深刻的认识和体验，实际项目的实践，让我体会到企业项目的严格和规范，分工合作也非常重要，团结互助才能更好完成任务。对我的自学能力，编码能力等有了很大提升。</p>
            </div>
            <div>
                <p>IOT-JavaWeb中间件平台</p>
...
<script type="text/javascript">
    $(function () {
        ...
        function changepic() {
            ...
            var c = document.getElementsByClassName("circle4");
            c[0].src = pic[i];
            i++;
