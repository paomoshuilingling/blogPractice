        ...
        <ul>
            ...
            <li id="link">
                ...
                <ul>
                    ...
                    <li><a href="http://weibo.com/u/2704130365/home?wvr=5&sudaref=security.weibo.com" target="_blank">泡沫水灵灵的微博</a>
                    </li>
...
<script type="text/javascript">
    $(function () {
        ...
        /* //瀑布流函数2
         var jslis = $(".js").children("ul").children("li");
         var jsli_height = {C1: [], C2: [], C3: [], C4: []};
         var jsli_imgtotal = jslis.children("canvas");
         var jslisspan = $(".js").children("ul").children("li").children("ul");
         for (var i = 0; i < jslis.length; i++) {
         //li的高度和宽度
         jslis.eq(i).css("height", parseInt(200 + Math.random() * 50 + "px"));
         //lis.eq(i).css("border", "1px solid");
         //canvas的高度和宽度
         var jsliw = parseInt(170);
         var jslih = parseInt(150 + Math.random() * 50);
         jsli_imgtotal.eq(i).css("width", jsliw + "px");
         jsli_imgtotal.eq(i).css("height", jslih + "px");
         jsli_imgtotal[i].id = "pubuliujs" + i;
         var jsimg = new Image();
         jsimg.src = '../../design/pubuliu/js/' + i + '.jpg';
         draw2(jsli_imgtotal[i].id, jsimg, jsliw, jslih);
         var jscol = i % 4;
         switch (jscol) {
         case 0:
         jslis.eq(i).css("left", "5px");
         jsli_height.C1.push(parseInt(jslis.eq(i).css("height")));
         var jsrow = Math.floor(i / 4);
         if (!jsrow) {
         jslis.eq(i).css("top", "0");
         } else {
         var jstop = 0;
         for (var j = 0; j < jsrow; j++) {
         jstop += jsli_height.C1[j];
         jstop += 10;
         }
         jslis.eq(i).css("top", jstop + "px");
         }
         break;
         case 1:
         jslis.eq(i).css("left", "190px");
         jsli_height.C2.push(parseInt(jslis.eq(i).css("height")));
         var jsrow = Math.floor(i / 4);
         if (!jsrow) {
         jslis.eq(i).css("top", "0");
         } else {
         ...
         break;
         case 2:
         jslis.eq(i).css("left", "375px");
         jsli_height.C3.push(parseInt(jslis.eq(i).css("height")));
         var jsrow = Math.floor(i / 4);
         if (!jsrow) {
         jslis.eq(i).css("top", "0");
         } else {
         ...
         break;
         case 3:
         jslis.eq(i).css("left", "560px");
         jsli_height.C4.push(parseInt(jslis.eq(i).css("height")));
         var jsrow = Math.floor(i / 4);
         if (!jsrow) {
         jslis.eq(i).css("top", "0");
         } else {
         ...
         //文字部分的高度和宽度
         jslisspan[i].style.backgroundColor = "rgb(" + parseInt(Math.random() * 255) + "," + parseInt(Math.random() * 255) + "," + parseInt(Math.random() * 255) + ")";
         }*/
    });
